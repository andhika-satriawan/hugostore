...
<html lang="en">
  <head>
    ...
    <title>Customers | Hugostore</title>
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="/customers">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link active" href="/all-products"><span class="nav-icon"></span> All Products</a></li>
            <li class="nav-item"><a class="nav-link" href="/add-new-product"><span class="nav-icon"></span> Add New</a></li>
            <li class="nav-item"><a class="nav-link" href="buttons/dropdowns.html"><span class="nav-icon"></span> Categories</a></li>
                      ...
                      <tr>
                        ...
                        <td>
                            <div class="avatar avatar-md">
                                <img class="avatar-img" src="assets/img/avatars/6.jpg" alt="user@email.com">
                            </div> 
                            mark
                        </td>
                        <td>Mark</td>
