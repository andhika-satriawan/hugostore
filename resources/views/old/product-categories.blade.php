...
<html lang="en">
  <head>
    ...
    <title>Product Categories | Hugostore</title>
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="/customers">
          ...
          <ul class="nav-group-items">
            ...
            <li class="nav-item"><a class="nav-link active" href="/product-categories"><span class="nav-icon"></span> Categories</a></li>
            <li class="nav-item"><a class="nav-link" href="/tags"><span class="nav-icon"></span> Tags</a></li>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <br>
                        <button class="btn btn-primary" type="button">Add New Category</button>
                      </div>
                      <div class="col-md-8">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                              <tr>
                                <th scope="row">
                                    <img class="categories-img" src="assets/img/categories/Evo-Nano-150x150.png" alt="user@email.com">
                                </th>
                                <td>Evo Nano</td>
