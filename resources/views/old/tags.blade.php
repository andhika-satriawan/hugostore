      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="/customers">
          ...
          <ul class="nav-group-items">
            ...
            <li class="nav-item"><a class="nav-link" href="/add-new-product"><span class="nav-icon"></span> Add New</a></li>
            <li class="nav-item"><a class="nav-link" href="/product-categories"><span class="nav-icon"></span> Categories</a></li>
            <li class="nav-item"><a class="nav-link active" href="/tags"><span class="nav-icon"></span> Tags</a></li>
            <li class="nav-item"><a class="nav-link" href="/reviews"><span class="nav-icon"></span> Reviews</a></li>
          </ul>
        </li>
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Tags</span></li>
            </ol>
          </nav>
        </div>
      </header>
          ...
          <div class="card mb-4">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <h6>Add New Tag</h6>
                        <label class="" for="name-categories">Name</label>
                        <input class="form-control" type="text" name="post_title" size="30" value="" id="name-categories" spellcheck="true" autocomplete="off">
                        <label class="" for="slug-categories">Slug</label>
                        <input class="form-control" type="text" name="post_title" size="30" value="" id="slug-categories" spellcheck="true" autocomplete="off">
                        <label class="form-label" for="desc-categories">Description</label>
                        <textarea class="form-control" id="desc-categories" rows="3"></textarea>
                        <br>
                        <button class="btn btn-primary" type="button">Add New Tag</button>
                      </div>
                      <div class="col-md-8">
                        <div class="input-group search-group">
                            <input class="form-control" type="text" placeholder="Search Sale" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            <button class="input-group-text" id="basic-addon2"><i class="icon icon-2xl cil-search"></i></button>
                        </div>
