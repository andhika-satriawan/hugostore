  ...
  <body>
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link active" href="/sales">
            <svg class="nav-icon">
        ...
        <li class="nav-item"><a class="nav-link" href="typography.html">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="buttons/buttons.html"><span class="nav-icon"></span> All Products</a></li>
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Sales</span></li>
            </ol>
            <button class="btn btn-primary" type="button">Add Sale</button>
          </nav>
        </div>
      </header>
