...
<body @yield('body-class')>
    ...
    <div id="main">
        ...
        <!-- header end-->
        <!-- left-header-->
        @include('partials.app.left-header')
        <!-- left-header end-->
        <!-- share button-->
        @include('partials.app.share-button')
        <!-- share button end-->
        <!-- right header-->
        @include('partials.app.right-header')
        <!-- right header end-->
        <!-- wrapper  -->
        <div id="wrapper">
            <!-- content-holder  -->
            <!-- navigation menu-->
            @include('partials.app.navigation-menu')
            <!-- navigation menu end  -->
            <!-- hero-wrap-->
            <!-- content-->
            @yield('content-web')
