                    ...
                    <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select" name="brand">
                                ...
                                @foreach ($brands as $brand)
                                    <option value="{{ $brand->name }}" @if ($brand->name == old('brand')) selected @endif>
                                        {{ $brand->name }}</option>
                                @endforeach
                            </select>
                        </div>
                                    ...
                                    <optgroup label="{{ $brand->name }}">
                                        @foreach ($brand->brand_types as $brandType)
                                            <option value="{{ $brandType->name }}"
                                                @if ($brandType->name == old('brand_type')) selected @endif>
                                                {{ $brandType->name }}
                                            </option>
                                        @endforeach
                                    </optgroup>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <textarea name="description" class="form-control" value="{{ old('description') }}">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
@push('add-script')
    ...
    <script>
        $(document).ready(function() {
            $("#slider ul li:last-child a").addClass("active");
