    ...
    <div class="page-header">
        <div class="page-title">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Brand Type</li>
            </ul>
        </div>
        <div class="page-btn">
            <a href="{{ route('admin.brandtype.create') }}" class="btn btn-added">
...
@push('add-script')
    ...
    <script>
        $(document).ready(function() {
            $("#product ul li:nth-child(9) a").addClass("active");
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#table_product_categories').DataTable({
                paging: false,
                searching: false,
                ajax: "{{ route('admin.brandtype.index') }}",
                columns: [{
                        data: 'checkbox',
                        name: 'checkbox'
                    },
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'DELETE',
                        url: '{{ route('admin.brandtype.index') }}/' + id,
                        data: {
