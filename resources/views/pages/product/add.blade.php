            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-body">
                                        ...
                                        <optgroup label="{{ $brand->name }}">
                                            @foreach ($brand->brand_types as $brandType)
                                                <option value="{{ $brandType->id }}"
                                                    @if ($brandType->id == old('brand_types')) selected @endif>
                                                    {{ $brandType->name }}
                                                </option>
                                            @endforeach
                                        </optgroup>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <textarea id="text-desc" name="description" class="form-control" value="{{ old('description') }}" hidden>{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr id="element-variant">
                                        ...
                                        <td class="upload-product">
                                            <input class="upload-file-variant" type="file" accept="image/*"
                                                ...
                                                value="{{ old('productDetails[0][photo_variant]') }}">
