...
@section('body-class')
    class="page-template-default page page-id-739 wp-embed-responsive theme-zonar woocommerce-checkout woocommerce-page
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 34 34">
                    ...
                    <circle cx="16" cy="16" r="15.9155"
                        class="progress-bar__progress 
                                    js-progress-bar"
                        style="stroke-dashoffset: 76.2808px;"></circle>
                </svg>
            </div>
        </div>
                    ...
                    <div class="woocommerce">
                        ...
                        <div class="woocommerce-form-login-toggle">
                            ...
                            <div class="woocommerce-info">
                                Returning customer? <a href="https://hugostore.id/checkout/#" class="showlogin">Click here
                                    to login</a> </div>
                        </div>
                        <form class="woocommerce-form woocommerce-form-login login" method="post" style="display:none;">
                            ...
                            <p class="form-row form-row-last">
                                ...
                                <span class="password-input"><input class="input-text woocommerce-Input" type="password"
                            ...
                            <p class="form-row">
                                ...
                                <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
                                    value="d6ac6224e0"><input type="hidden" name="_wp_http_referer" value="/checkout/">
                                <input type="hidden" name="redirect" value="https://hugostore.id/checkout/">
                                <button type="submit"
                        ...
                        <form name="checkout" method="post" class="checkout woocommerce-checkout"
                            action="https://hugostore.id/checkout/" enctype="multipart/form-data"
                                                ...
                                                <p class="form-row address-field validate-required form-row-wide"
                                                    ...
                                                    <label for="shipping_city" class="">Town / City&nbsp;<abbr
                                                        ...
                                                        class="woocommerce-input-wrapper"><input type="text"
                                                            ...
                                                            id="shipping_city" placeholder="" value=""
                                                            autocomplete="address-level2"></span>
                                                </p>
                                                <p class="form-row address-field validate-required validate-state form-row-wide"
                                                            ...
                                                            dir="ltr" style="width: 100%;"><span
                                                                class="selection"><span
                                                                    ...
                                                                    role="combobox"><span
                                                                        ...
                                                                        role="textbox" aria-readonly="true"
                                                                        title="DKI Jakarta">DKI Jakarta</span><span
                                                                        class="select2-selection__arrow"
                                                                        role="presentation"><b
                                                                            role="presentation"></b></span></span></span><span
                                                                class="dropdown-wrapper"
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            <td class="product-name">
                                                Dragonfish&nbsp; <strong class="product-quantity">×&nbsp;1</strong> </td>
                                            <td class="product-total">
                                                <span class="woocommerce-Price-amount amount"><bdi><span
                                                            class="woocommerce-Price-currencySymbol">Rp</span>15.000.000</bdi></span>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        ...
                                        <tr class="order-total">
                                            ...
                                            <td><strong><span class="woocommerce-Price-amount amount"><bdi><span
                                                                class="woocommerce-Price-currencySymbol">Rp</span>15.000.000</bdi></span></strong>
                                            </td>
                                        </tr>
                                ...
                                <div id="payment" class="woocommerce-checkout-payment">
                                    ...
                                    <div class="form-row place-order">
                                        ...
                                        <input type="hidden" id="woocommerce-process-checkout-nonce"
                                            name="woocommerce-process-checkout-nonce" value="6ac943a2dd"><input
