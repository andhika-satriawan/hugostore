...
@section('content-web')
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 34 34">
                    ...
                    <circle cx="16" cy="16" r="15.9155"
                        class="progress-bar__progress 
                                    js-progress-bar"
                        style="stroke-dashoffset: 19.6787px;"></circle>
                </svg>
            </div>
        </div>
                    ...
                    <div class="woocommerce">
                        ...
                        <div class="woocommerce-MyAccount-content">
                            ...
                            <div class="wcrw-all-request-wrapper ">
                                ...
                                <table
                                    class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders">
                                    <thead>
                                        <tr>
                                            <th>Request ID</th>
                                            <th>Order ID</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="https://hugostore.id/my-account/view-warranty-request/1">Request
                                                    #1</a>
                                            </td>
                                            <td>
                                                <a href="https://hugostore.id/my-account/view-order/170">Order #170</a>
                                            </td>
                                            <td>
                                                Replacement </td>
                                            <td>
                                                <a href="https://hugostore.id/my-account/warranty-requests/#">Black Coat</a>
                                                × 1
                                            </td>
                                            <td>
                                                <span class="status-class status-processing">Processing<span> </span></span>
                                            </td>
                                            <td>
                                                November 13, 2022 </td>
                                        </tr>
    ...
    <div class="share-wrapper">
        ...
        <div class="share-container fl-wrap  isShare"
            ...
            <a href="http://www.facebook.com/share.php?u=https%3A%2F%2Fhugostore.id%2Fmy-account%2Fwarranty-requests%2F"
                class="pop share-icon share-icon-facebook"></a><a
                href="http://pinterest.com/pin/create/button/?url=https%3A%2F%2Fhugostore.id%2Fmy-account%2Fwarranty-requests%2F&amp;media=&amp;description="
                class="pop share-icon share-icon-pinterest"></a><a
                href="http://www.tumblr.com/share?v=3&amp;u=https%3A%2F%2Fhugostore.id%2Fmy-account%2Fwarranty-requests%2F"
                ...
                href="http://www.linkedin.com/shareArticle?mini=true&amp;url=https%3A%2F%2Fhugostore.id%2Fmy-account%2Fwarranty-requests%2F&amp;title=My%20account%20%E2%80%93%20Hugostore&amp;summary=&amp;source=in1.com"
