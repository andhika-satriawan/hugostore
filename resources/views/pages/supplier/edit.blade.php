            ...
            <form action="{{ route('supplier.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-groupicon">
                      <input type="text" name="name" placeholder="Supplier Name" value="{{ $item->name }}" />
                    </div>
                </div>
                <div class="form-group">
                    <label>Slug</label>
                    <div class="input-groupicon">
                    <input type="text" name="slug" placeholder="Supplier Slug" value="{{ $item->slug }}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label>Phone</label>
                    <div class="input-groupicon">
                        <input type="text" name="phone" placeholder="Supplier Phone" value="{{ $item->phone }}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label>Address</label>
