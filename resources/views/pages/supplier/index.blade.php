...
<div class="page-header">
  ...
  <div class="page-btn">
    <a href="{{ route('supplier.create') }}" class="btn btn-added">
      ...
      <div class="search-set">
        <div class="search-path">
          <a class="btn btn-filter" id="filter_search">
            ...
            <span
              ><img src="{{ asset('template/img/icons/closes.svg') }}" alt="img"
            /></span>
          </a>
        </div>
        ...
        <ul>
          <li>
            <a
              ...
              title="pdf"
              ><img src="{{ asset('template/img/icons/pdf.svg') }}" alt="img"
            /></a>
          </li>
          <li>
            <a
              ...
              data-bs-placement="top"
              title="excel"
              ><img src="{{ asset('template/img/icons/excel.svg') }}" alt="img"
            /></a>
          </li>
          <li>
            <a
              ...
              data-bs-placement="top"
              title="print"
              ><img src="{{ asset('template/img/icons/printer.svg') }}" alt="img"
            /></a>
          </li>
        </ul>
      </div>
          ...
          <div class="col-lg-1 col-sm-6 col-12">
            <div class="form-group">
              <a class="btn btn-filters ms-auto"
                ><img
                  src="{{ asset('template/img/icons/search-whites.svg') }}"
                  alt="img"
              /></a>
            </div>
          </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success == true) {
                            ...
                            $('#table_suppliers').DataTable().ajax.reload();
                        }
                    } 
                });
            }
