...
class ProductSubCategoryController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($data)->addIndexColumn()
                ...
                ->addColumn('action', function ($row) {
                    $btn = '
                    <a class="me-3" href="' . route('subcategory.edit', $row->id) . '">
    ...
    public function create()
    {
        ...
        return view('pages.product.subcategory.add', [
    ...
    public function store(Request $request)
    {
        ...
        return to_route('subcategory.index')->with('success', 'Input Data Success!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.product.subcategory.edit', [
            'categories' => $categories,
            'item'  => $item
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return to_route('subcategory.index')->with('success', 'Update Data Success!');
    }
