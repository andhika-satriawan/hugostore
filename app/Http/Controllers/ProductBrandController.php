...
class ProductBrandController extends Controller
{
    ...
    {
        return view('pages.product.brand.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return to_route('brand.index')->with('success', 'Input Data Success!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.product.brand.edit', [
            'item'  => $item
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return to_route('brand.index')->with('success', 'Update Data Success!');
    }
