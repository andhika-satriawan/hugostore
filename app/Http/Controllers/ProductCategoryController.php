...
class ProductCategoryController extends Controller
{
    ...
    {
        return view('pages.product.category.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        return to_route('category.index')->with('success', 'Input Data Success!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return to_route('category.index')->with('success', 'Update Data Success!');
    }
