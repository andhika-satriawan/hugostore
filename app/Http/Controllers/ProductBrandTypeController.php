...
class ProductBrandTypeController extends Controller
{
    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            return DataTables::of($data)->addIndexColumn()
                ...
                ->addColumn('action', function ($row) {
                    $btn = '
                    <a class="me-3" href="' . route('brandtype.edit', $row->id) . '">
        ...
        return view('pages.product.brandtype.index');
    }
    ...
    public function create()
    {
        ...
        return view('pages.product.brandtype.add', [
            'brands' => $brands
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return to_route('brandtype.index')->with('success', 'Input Data Success!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.product.brandtype.edit', [
            'brands' => $brands,
            'item'  => $item
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return to_route('brandtype.index')->with('success', 'Update Data Success!');
    }
